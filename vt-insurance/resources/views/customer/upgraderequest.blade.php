    ...
    <div class="row">
        <div class="col">
            <div class="float-start px-4 pt-2">
                <h1 class="display-6">Upgrade Request</h1>
            </div>

            <div class="float-end p-2">
                <a class="btn btn-success " href="{{ route('mypolicies') }}"> View All Policy</a>
            </div>
        </div>
    </div>
    <hr>
            ...
            <div class="container p-5 my-3 border">
                ...
                <form class="lead" action="{{ route('request.store') }}" method="POST">
                    ...
                    <div class="mb-3 d-none">
                        ...
                        <input type="text" class="form-control" name="policy_id" value="{{ $policy->policy_id }}"
                            readonly placeholder="">
                    </div>
                    <div class="mb-3 d-none">
                        <label class="form-label"> <strong> Customer ID</strong></label>
                        <input type="text" class="form-control" name="customer_id" value="{{ $policy->customer_id }}"
                            readonly placeholder="">
                    </div>
                    <div class="mb-3">
                        <label class="form-label"> <strong> Policy Type</strong></label>
                        <input type="text" class="form-control" name="policy_type" value="{{ $policy->policy_type }}"
                            readonly placeholder="Enter Policy Name">

                    </div>
                    <div class="mb-3">
                        <label class="form-label"> <strong>Coverage Amount</strong></label>
                        <input type="text" class="form-control" id="coverage_amount"
                            value="{{ $policy->coverage_amount }}" name="coverage_amount"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="premium_amount" name="premium_amount"
                            placeholder="Enter Policy Amount" value="{{ $policy->premium_amount }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="excess_amount" name="excess_amount"
                            placeholder="Enter Policy Amount" value="{{ $policy->excess_amount }}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label"> <strong> Policy Duration</strong></label>
                        <input type="text" class="form-control" value="{{ $policy->policy_duration }}"
