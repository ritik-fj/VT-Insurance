    ...
    <div class="container p-5 my-3 border">
        ...
        <form class="lead" action="{{ route('policies.update', $policies->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{ $policies->coverage_amount }}" id="coverage_amount"
                    name="coverage_amount" placeholder="Enter Coverage Amount">
            </div>
            <div class="mb-3">
                <label class="form-label"> <strong>Premium Amount</strong></label>
                <input type="text" class="form-control" value="{{ $policies->premium_amount }}" id="premium_amount"
                    name="premium_amount" placeholder="Enter Policy Amount">
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="excess_amount" name="excess_amount"
                    value="{{ $policies->excess_amount }}" placeholder="Enter Excess Amount">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea id="description" name="description" class="form-control" rows="3" required>{{ $policies->description }}</textarea>
            </div>
