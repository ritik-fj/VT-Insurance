...
class PoliciesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.managepolicies', ['policies' => $policies, 'searchTerm' => $searchTerm]);
    }
    ...
    public function store(Request $request)
    {
        ...
        //redirect
        return redirect()->route('managepolicies')->with('success', 'Policy Created Successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        //redirect
        return redirect()->route('managepolicies')->with('success', 'Policy Deleted Successfully');
    }
}
